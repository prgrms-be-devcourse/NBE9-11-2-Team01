...
public class QPostLike extends EntityPathBase<PostLike> {
    ...
    private static final long serialVersionUID = 888820001L;
    ...
    public final com.team01.backend.domain.user.entity.QUser user;
    ...
    public QPostLike(Class<? extends PostLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.team01.backend.domain.user.entity.QUser(forProperty("user")) : null;
    }
